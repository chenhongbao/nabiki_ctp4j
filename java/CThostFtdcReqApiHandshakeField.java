...
public class CThostFtdcReqApiHandshakeField {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        ThostFtdcCtpApiJNI.delete_CThostFtdcReqApiHandshakeField(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setCryptoKeyVersion(String value) {
    ThostFtdcCtpApiJNI.CThostFtdcReqApiHandshakeField_CryptoKeyVersion_set(swigCPtr, this, value);
  }

  public String getCryptoKeyVersion() {
    return ThostFtdcCtpApiJNI.CThostFtdcReqApiHandshakeField_CryptoKeyVersion_get(swigCPtr, this);
  }

  public CThostFtdcReqApiHandshakeField() {
    this(ThostFtdcCtpApiJNI.new_CThostFtdcReqApiHandshakeField(), true);
  }
